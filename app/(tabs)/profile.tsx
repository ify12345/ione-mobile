...
export default function ProfileScreen() {
  ...
  return (
    <SafeAreaScreen className="py-6 px-4 gap-5">
      ...
      <View className='flex-col gap-2 shadow-sm p-4 bg-white dark:bg-[#1f1f1f] rounded-lg w-full py-5'>
        <ThemedText type="default" className='text-lg font-bold'>
          Rider Info
        </ThemedText>
        <View className='flex-row justify-between items-center border-stroke border-b pb-2'>
           <View className='flex-row items-center gap-3'>
             <ThemedText lightColor='#000' darkColor='#46BB1C' type="default" className=''>
              Phone Number
            </ThemedText>
             <ThemedText type="medium" className=''>
              +234 810 123 4567
            </ThemedText>
           </View>
        </View>
      ...
      <TouchableOpacity 
        className='flex-row justify-between items-center gap-2 shadow-sm p-4 bg-white dark:bg-[#1f1f1f] rounded-lg w-full'
